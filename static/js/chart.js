...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Chart = e() }(this, (function() {
    "use strict";
    var t = Object.freeze({ __proto__: null, get Colors() { return jo }, get Decimation() { return Uo }, get Filler() { return ha }, get Legend() { return fa }, get SubTitle() { return ba }, get Title() { return pa }, get Tooltip() { return La } });
    ...
    function b(t, e, i) {
        ...
        let l;
        for (let e = 0; e < a; ++e) { if (l = s[e], !o(l)) continue; const n = Object.keys(l); for (let e = 0, s = n.length; e < s; ++e) r(n[e], t, l, i) }
        return t
    }
    ...
    function at(t, e) {
        t._chartjs ? t._chartjs.listeners.push(e) : (Object.defineProperty(t, "_chartjs", { configurable: !0, enumerable: !1, value: { listeners: [e] } }), ot.forEach((e => {
            const i = "_onData" + w(e),
                s = t[e];
    ...
    function lt(t) { const e = new Set; let i, s; for (i = 0, s = t.length; i < s; ++i) e.add(t[i]); return e.size === s ? t : Array.from(e) }
    const ht = "undefined" == typeof window ? function(t) { return t() } : window.requestAnimationFrame;

    function ct(t, e) {
        let i = [],
            s = !1;
        return function(...n) { i = n, s || (s = !0, ht.call(window, (() => { s = !1, t.apply(e, i) }))) }
    }
    ...
    function Bt(t) {
        ...
        const n = Vt(+e[2]),
            o = +e[3] / 100,
            a = +e[4] / 100;
        return i = "hwb" === e[1] ? function(t, e, i) { return zt(Rt, t, e, i) }(n, o, a) : "hsv" === e[1] ? function(t, e, i) { return zt(Et, t, e, i) }(n, o, a) : Ft(n, o, a), { r: i[0], g: i[1], b: i[2], a: s }
    }
    const Nt = { x: "dark", Z: "light", Y: "re", X: "blu", W: "gr", V: "medium", U: "slate", A: "ee", T: "ol", S: "or", B: "ra", C: "lateg", D: "ights", R: "in", Q: "turquois", E: "hi", P: "ro", O: "al", N: "le", M: "de", L: "yello", F: "en", K: "ch", G: "arks", H: "ea", I: "ightg", J: "wh" },
    ...
    class Zt {
        constructor(t) { if (t instanceof Zt) return t; const e = typeof t; let i; var s, n, o; "object" === e ? i = Kt(t) : "string" === e && (o = (s = t).length, "#" === s[0] && (4 === o || 5 === o ? n = { r: 255 & 17 * St[s[1]], g: 255 & 17 * St[s[2]], b: 255 & 17 * St[s[3]], a: 5 === o ? 17 * St[s[4]] : 255 } : 7 !== o && 9 !== o || (n = { r: St[s[1]] << 4 | St[s[2]], g: St[s[3]] << 4 | St[s[4]], b: St[s[5]] << 4 | St[s[6]], a: 9 === o ? St[s[7]] << 4 | St[s[8]] : 255 })), i = n || jt(t) || Gt(t)), this._rgb = i, this._valid = !!i }
    ...
    const oe = {
        ...
        logarithmic(t, e, i) { if (0 === t) return "0"; const s = i[e].significand || t / Math.pow(10, Math.floor(z(t))); return [1, 2, 3, 5, 10, 15].includes(s) || e > .8 * i.length ? oe.numeric.call(this, t, e, i) : "" }
    };
    ...
    function $e(t, e = { scriptable: !0, indexable: !0 }) { const { _scriptable: i = e.scriptable, _indexable: s = e.indexable, _allKeys: n = e.allKeys } = t; return { allKeys: n, scriptable: i, indexable: s, isScriptable: S(i) ? i : () => i, isIndexable: S(s) ? s : () => s } }
    ...
    function qe(t, e, i) { return S(t) ? t(e, i) : t }
    ...
    function ei(t, e, i, s) { const { iScale: n } = t, { key: o = "r" } = this._parsing, a = new Array(s); let r, l, h, c; for (r = 0, l = s; r < l; ++r) h = r + i, c = e[h], a[r] = { r: n.parse(M(c, o), h) }; return a }
    ...
    function ai(t, e = "x") {
        ...
        for (a = 0; a < s; ++a)
            ...
            }! function(t, e, i) { const s = t.length; let n, o, a, r, l, h = si(t, 0); for (let c = 0; c < s - 1; ++c) l = h, h = si(t, c + 1), l && h && (V(e[c], 0, ii) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c]))) }(t, n, o),
        function(t, e, i = "x") {
            const s = ni(i),
                n = t.length;
            let o, a, r, l = si(t, 0);
    ...
    function li(t, e, i, s, n) {
        ...
        e.capBezierPoints && function(t, e) { let i, s, n, o, a, r = Ee(t[0], e); for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && Ee(t[i + 1], e), o && (n = t[i], a && (n.cp1x = ri(n.cp1x, e.left, e.right), n.cp1y = ri(n.cp1y, e.top, e.bottom)), r && (n.cp2x = ri(n.cp2x, e.left, e.right), n.cp2y = ri(n.cp2y, e.top, e.bottom))) }(t, i)
    }
    const hi = t => 0 === t || 1 === t,
        ...
        ui = {
            ...
            easeInOutElastic(t) { const e = .1125; return hi(t) ? t : t < .5 ? .5 * ci(2 * t, e, .45) : .5 + .5 * di(2 * t - 1, e, .45) },
    ...
    function Li(t, e, i) {
        if (!i) return [t];
        const { property: s, start: n, end: o } = i, a = e.length, { compare: r, between: l, normalize: h } = Ai(s), { start: c, end: d, loop: u, style: f } = function(t, e, i) {
            const { property: s, start: n, end: o } = i, { between: a, normalize: r } = Ai(s), l = e.length;
        ...
        const y = () => x || l(n, b, p) && 0 !== r(n, b),
            v = () => !x || 0 === r(o, p) || l(o, b, p);
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ti({ start: _, end: t, loop: u, count: a, style: f })), _ = null), i = t, b = p));
    ...
    function Fi(t, e) { return e && JSON.stringify(t) !== JSON.stringify(e) }
    ...
    function Ni(t, e, i, s, n) {
        ...
        for (let t = 0, i = o.length; t < i; ++t) {
            const { index: i, data: r } = o[t], { lo: l, hi: h } = Bi(o[t], e, a, n);
            for (let t = l; t <= h; ++t) {
                const e = r[t];
                e.skip || s(e, i, t)
            }
    ...
    function $i(t, e, i, s, n) {
        ...
        let r = !1;
        return Ni(t, i, e, ((t, s, l) => { t[a](e[i], n) && (o.push({ element: t, datasetIndex: s, index: l }), r = r || t.inRange(e.x, e.y, n)) })), s && !r ? [] : o
    }
    var Yi = {
    ...
    var ns = {
        ...
        update(t, e, i, s) {
            ...
            es(r.fullSize, g, d, p), es(l, g, d, p), es(h, g, d, p) && es(l, g, d, p),
                ...
                }(g), ss(r.leftAndTop, g, d, p), g.x += g.w, g.y += g.h, ss(r.rightAndBottom, g, d, p), t.chartArea = { left: g.left, top: g.top, right: g.left + g.w, bottom: g.top + g.h, height: g.h, width: g.w }, u(r.chartArea, (e => {
                    const i = e.box;
    ...
    function _s(t, e, i) {
        ...
        return function(t, e, i) { t.addEventListener(e, i, hs) }(s, e, n), n
    }
    class ys extends os {
        acquireContext(t, e) {
    ...
    function vs(t) { return !fe() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? as : ys }
    ...
    class Vs {
        ...
        getMinMax(t, e) {
            ...
            function g() { f = s[u]; const e = f[r.axis]; return !a(f[t.axis]) || c > e || d < e }
        ...
        _update(t) {
            const e = this._cachedMeta;
            this.update(t || "default"), e._clip = function(t) { let e, i, s, n; return o(t) ? (e = t.top, i = t.right, s = t.bottom, n = t.left) : e = i = s = n = t, { top: e, right: i, bottom: s, left: n, disabled: !1 === t } }(l(this.options.clip, function(t, e, i) {
                if (!1 === i) return !1;
                const s = Ds(t, i),
                    n = Ds(e, i);
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                n = e.$context || (e.$context = function(t, e, i) { return Pi(t, { active: !1, dataIndex: e, parsed: void 0, raw: void 0, element: i, index: e, mode: "default", type: "data" }) }(this.getContext(), t, e)), n.parsed = this.getParsed(t), n.raw = s.data[t], n.index = n.dataIndex = t
            } else n = this.$context || (this.$context = function(t, e) { return Pi(t, { active: !1, dataset: void 0, datasetIndex: e, index: e, mode: "default", type: "dataset" }) }(this.chart.getContext(), this.index)), n.dataset = s, n.index = n.datasetIndex = this.index;
    ...
    function Ns(t, e) {
        ...
        if (r > 0) { let t, i; const n = r > 1 ? Math.round((h - l) / (r - 1)) : null; for (Ws(e, c, d, s(n) ? 0 : l - n, l), t = 0, i = r - 1; t < i; t++) Ws(e, c, d, a[t], a[t + 1]); return Ws(e, c, d, h, s(n) ? e.length : h + n), c }
        return Ws(e, c, d), c
    }
    ...
    class Ks extends Bs {
        ...
        _computeLabelSizes(t, e, i) {
            const { ctx: o, _longestTextCache: a } = this, r = [], l = [], h = Math.floor(e / js(e, i));
        ...
        _computeGridLineItems(t) {
            ...
            for (_ = 0; _ < d; _ += T) {
                ...
                y = Ys(this, _, h), void 0 !== y && (v = Oe(i, y, o), c ? M = k = P = C = v : w = S = D = O = v, f.push({ tx1: M, ty1: w, tx2: k, ty2: S, x1: P, y1: D, x2: C, y2: O, width: o, color: a, borderDash: l, borderDashOffset: d, tickWidth: u, tickColor: g, tickBorderDash: p, tickBorderDashOffset: m }))
            }
        ...
        _layers() {
            ...
            return this._isVisible() && this.draw === Ks.prototype.draw ? [{ z: i, draw: t => { this.drawBackground(), this.drawGrid(t), this.drawTitle() } }, { z: s, draw: () => { this.drawBorder() } }, { z: e, draw: t => { this.drawLabels(t) } }] : [{ z: e, draw: t => { this.draw(t) } }]
        }
    ...
    class Zs {
        constructor() { this.controllers = new Gs(Vs, "datasets", !0), this.elements = new Gs(Bs, "elements"), this.plugins = new Gs(Object, "plugins"), this.scales = new Gs(Ks, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements] }
    ...
    function an(t) { return (t = t || {}).datasets = t.datasets || [], t.labels = t.labels || [], t }
    const rn = new Map,
        ln = new Set;

    function hn(t, e) { let i = rn.get(t); return i || (i = e(), rn.set(t, i), ln.add(i)), i }
    const cn = (t, e, i) => {
        const s = M(e, i);
        void 0 !== s && t.add(s)
    };
    class dn {
        constructor(t) { this._config = function(t) { return (t = t || {}).data = an(t.data), on(t), t }(t), this._scopeCache = new Map, this._resolverCache = new Map }
        ...
        getOptionScopes(t, e, i) {
            ...
            if (a) return a;
            const r = new Set;
            e.forEach((e => { t && (r.add(t), e.forEach((e => cn(r, t, e)))), e.forEach((t => cn(r, s, t))), e.forEach((t => cn(r, re[n] || {}, t))), e.forEach((t => cn(r, ue, t))), e.forEach((t => cn(r, le, t))) }));
        ...
        createResolver(t, e, i = [""], s) { const { resolver: n } = un(this._resolverCache, t, i); return o(e) ? je(n, e, void 0, s) : n }
    }
    ...
    function un(t, e, i) {
        ...
        const n = i.join();
        let o = s.get(n);
        if (!o) { o = { resolver: He(e, i), subPrefixes: i.filter((t => !t.toLowerCase().includes("hover"))) }, s.set(n, o) }
        return o
    }
    ...
    function _n(t) { return fe() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t }
    const yn = {},
    ...
    class wn {
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                ...
                else { h = new(Js.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this }), i[h.id] = h }
                h.init(n, t)
            })), u(s, ((t, e) => { t || delete i[e] })), u(i, (t => { ns.configure(this, t, t.options), ns.addBox(this, t) }))
        }
        _updateMetasets() {
        ...
        update(t) {
            ...
            o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || u(n, (t => { t.reset() })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", { mode: t }), this._layers.sort(mn("z", "_idx"));
        ...
        render() {!1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) && (xt.has(this) ? this.attached && !xt.running(this) && xt.start(this) : (this.draw(), bn({ chart: this }))) }
        draw() {
            let t;
        ...
        _drawDataset(t) {
            ...
            !1 !== this.notifyPlugins("beforeDatasetDraw", o) && (s && Re(e, { left: !1 === i.left ? 0 : n.left - i.left, right: !1 === i.right ? this.width : n.right + i.right, top: !1 === i.top ? 0 : n.top - i.top, bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom }), t.controller.draw(), s && Ie(e), o.cancelable = !1, this.notifyPlugins("afterDatasetDraw", o))
        }
    ...
    function kn() { return u(wn.instances, (t => t._plugins.invalidate())) }

    function Sn() { throw new Error("This method is not implemented: Check that a complete date adapter is provided.") }
    class Pn {
        static override(t) { Object.assign(Pn.prototype, t) }
    ...
    function Tn(t) { return t && void 0 !== t.barStart && void 0 !== t.barEnd }

    function Ln(t, e, i, s) { let n = e.borderSkipped; const o = {}; if (!n) return void(t.borderSkipped = o); if (!0 === n) return void(t.borderSkipped = { top: !0, right: !0, bottom: !0, left: !0 }); const { start: a, end: r, reverse: l, top: h, bottom: c } = function(t) { let e, i, s, n, o; return t.horizontal ? (e = t.base > t.x, i = "left", s = "right") : (e = t.base < t.y, i = "bottom", s = "top"), e ? (n = "end", o = "start") : (n = "start", o = "end"), { start: i, end: s, reverse: e, top: n, bottom: o } }(t); "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[En(c, a, r, l)] = !0, n = h)), o[En(n, a, r, l)] = !0, t.borderSkipped = o }

    function En(t, e, i, s) { var n, o, a; return s ? (a = i, t = Rn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = Rn(t, e, i), t }

    function Rn(t, e, i) { return "start" === t ? e : "end" === t ? i : t }

    function In(t, { inflateAmount: e }, i) { t.inflateAmount = "auto" === e ? 1 === i ? .33 : 0 : e }
    class zn extends Vs {
        static id = "doughnut";
    ...
    var Vn = Object.freeze({
        ...
        BarController: class extends Vs {
            ...
            parsePrimitiveData(t, e, i, s) { return An(t, e, i, s) }
            parseArrayData(t, e, i, s) { return An(t, e, i, s) }
            parseObjectData(t, e, i, s) { const { iScale: n, vScale: o } = t, { xAxisKey: a = "x", yAxisKey: r = "y" } = this._parsing, l = "x" === n.axis ? a : r, h = "x" === o.axis ? a : r, c = []; let d, u, f, g; for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(M(g, l), d), c.push(On(M(g, h), f, o, d)); return c }
            updateRangeFromParsed(t, e, i, s) {
            ...
            updateElements(t, e, i, n) {
                ...
                for (let f = e; f < e + i; f++) {
                    const e = this.getParsed(f),
                        ...
                        p = (e._stacks || {})[r.axis],
                        m = { horizontal: h, base: i.base, enableBorderRadius: !p || Tn(e._custom) || a === p._top || a === p._bottom, x: h ? i.head : g.center, y: h ? g.center : i.head, height: h ? g.size : Math.abs(i.size), width: h ? Math.abs(i.size) : g.size };
            ...
            _calculateBarValuePixels(t) {
                const { _cachedMeta: { vScale: e, _stacked: i, index: n }, options: { base: o, minBarLength: a } } = this, r = o || 0, l = this.getParsed(t), h = l._custom, c = Tn(h);
                let d, u, f = l[e.axis],
                    g = 0,
            ...
            _calculateBarIndexPixels(t, e) {
                ...
                if (e.grouped) {
                    const i = o ? this._getStackCount(t) : e.stackCount,
                        ...
                        }(t, e, n, i) : function(t, e, i, n) { const o = i.barThickness; let a, r; return s(o) ? (a = e.min * i.categoryPercentage, r = i.barPercentage) : (a = o * n, r = 1), { chunk: a / n, ratio: r, start: e.pixels[t] - a / 2 } }(t, e, n, i),
    ...
    function Bn(t, e, i, s) {
        ...
        const o = (i - e) / 2,
            a = Math.min(o, s * e / 2),
            r = t => { const e = (i - Math.min(o, t)) * s / 2; return J(t, 0, Math.min(o, e)) };
    ...
    function Hn(t, e, i, s, n) {
        const { fullCircles: o, startAngle: a, circumference: r, options: l } = e, { borderWidth: h, borderJoinStyle: c } = l, d = "inner" === l.borderAlign;
        if (!h) return;
    ...
    function Gn(t, e, i, s) {
        ...
        }(t, e, i, s) : function(t, e, i, s) { const { segments: n, options: o } = e, a = qn(e); for (const r of n) jn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke() }(t, e, i, s)
    }
    class Zn extends Bs {
        static id = "line";
        ...
        interpolate(t, e) {
            ...
            if (!o.length) return;
            const a = [],
                r = function(t) { return t.stepped ? gi : t.tension || "monotone" === t.cubicInterpolationMode ? pi : fi }(i);
            let l, h;
    ...
    function to(t, e, i, s) { return t ? 0 : J(e, i, s) }
    ...
    var oo = Object.freeze({
        ...
        BarElement: class extends Bs {
            ...
            draw(t) {
                const { inflateAmount: e, options: { borderColor: i, backgroundColor: s } } = this, { inner: n, outer: o } = eo(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? We : so;
                var r;
    ...
    function ao(t, e, i, s) { const n = t.indexOf(e); if (-1 === n) return ((t, e, i, s) => ("string" == typeof e ? (i = t.push(e) - 1, s.unshift({ index: i, label: e })) : isNaN(e) && (i = null), i))(t, e, i, s); return n !== t.lastIndexOf(e) ? i : n }

    function ro(t) { const e = this.getLabels(); return t >= 0 && t < e.length ? e[t] : t }
    ...
    function go(t) { return 1 === t / Math.pow(10, uo(t)) }
    ...
    function mo(t, { min: e, max: i }) {
        ...
        const s = [],
            n = uo(e);
        let o = function(t, e) { let i = uo(e - t); for (; po(t, e, i) > 10;) i++; for (; po(t, e, i) < 10;) i--; return Math.min(i, uo(t)) }(e, i),
    ...
    function xo(t) { const e = t.ticks; if (e.display && t.display) { const t = Mi(e.backdropPadding); return l(e.font && e.font.size, ue.font.size) + t.height } return 0 }

    function _o(t, e, i, s, n) { return t === s || t === n ? { start: e - i / 2, end: e + i / 2 } : t < s || t > n ? { start: e - i, end: e } : { start: e, end: e + i } }
    ...
    function Mo(t) { return 0 === t || 180 === t ? "center" : t < 180 ? "left" : "right" }

    function wo(t, e, i) { return "right" === i ? t -= e : "center" === i && (t -= e / 2), t }

    function ko(t, e, i) { return 90 === i || 270 === i ? t -= e / 2 : (i > 270 || i < 90) && (t -= e), t }
    ...
    class Po extends ho {
        ...
        computeTickLimit() { return Math.ceil(this.drawingArea / xo(this.options)) }
        generateTickLabels(t) { ho.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => { const i = d(this.options.pointLabels.callback, [t, e], this); return i || 0 === i ? i : "" })).filter(((t, e) => this.chart.getDataVisibility(e))) }
        fit() {
            const t = this.options;
    ...
    class Ro extends Ks {
        ...
        parse(t, e) { return void 0 === t ? null : Ao(this, t) }
        ...
        buildTicks() {
            ...
            const n = this.min,
                o = nt(s, n, this.max);
            return this._unit = e.unit || (i.autoSkip ? To(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) { for (let o = Co.length - 1; o >= Co.indexOf(i); o--) { const i = Co[o]; if (Do[i].common && t._adapter.diff(n, s, i) >= e - 1) return i } return Co[i ? Co.indexOf(i) : 0] }(this, o.length, e.minUnit, this.min, this.max)), this._majorUnit = i.major.enabled && "year" !== this._unit ? function(t) {
        ...
        getLabelTimestamps() { const t = this._cache.labels || []; let e, i; if (t.length) return t; const s = this.getLabels(); for (e = 0, i = s.length; e < i; ++e) t.push(Ao(this, s[e])); return this._cache.labels = this._normalized ? t : this.normalize(t) }
        normalize(t) { return lt(t.sort(Oo)) }
    }
    ...
    var zo = Object.freeze({
        ...
        CategoryScale: class extends Ks {
            ...
            parse(t, e) { if (s(t)) return null; const i = this.getLabels(); return ((t, e) => null === t ? null : J(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : ao(i, t, l(e, t), this._addedLabels), i.length - 1) }
            ...
            getLabelForValue(t) { return ro.call(this, t) }
        ...
        TimeSeriesScale: class extends Ro {
            ...
            getDecimalForValue(t) { return (Io(this._table, t) - this._minPos) / this._tableRange }
            getValueForPixel(t) {
                const e = this._offsets,
                    i = this.getDecimalForPixel(t) / e.factor - e.end;
    ...
    function No(t) { return Vo[t % Vo.length] }

    function Wo(t) {
        let e = 0;
        return (i, s) => {
            const n = t.getDatasetMeta(s).controller;
            n instanceof zn ? e = function(t, e) { return t.backgroundColor = t.data.map((() => Bo(e++))), e }(i, e) : n instanceof Fn ? e = function(t, e) { return t.backgroundColor = t.data.map((() => No(e++))), e }(i, e) : n && (e = function(t, e) { return t.borderColor = Bo(e), t.backgroundColor = No(e), ++e }(i, e))
        }
    }
    ...
    function Yo(t) { t.data.datasets.forEach((t => { $o(t) })) }
    var Uo = {
        id: "decimation",
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach(((e, o) => {
                ...
                let { start: d, count: u } = function(t, e) { const i = e.length; let s, n = 0; const { iScale: o } = t, { min: a, max: r, minDefined: l, maxDefined: h } = o.getUserBounds(); return l && (n = J(it(e, o.axis, a).lo, 0, i - 1)), s = h ? J(it(e, o.axis, r).hi + 1, n, i) - n : i - n, { start: n, count: s } }(l, h);
                if (u <= (i.threshold || 4 * n)) return void $o(e);
                let f;
                switch (s(a) && (e._data = h, delete e.data, Object.defineProperty(e, "data", { configurable: !0, enumerable: !0, get: function() { return this._decimated }, set: function(t) { this._data = t } })), i.algorithm) {
                    case "lttb":
    ...
    function qo(t, e, i) { for (; e > t; e--) { const t = i[e]; if (!isNaN(t.x) && !isNaN(t.y)) break } return e }

    function Ko(t, e, i, s) { return t && e ? s(t[i], e[i]) : t ? t[i] : e ? e[i] : 0 }
    ...
    function Zo(t) { return t && !1 !== t.fill }
    ...
    function Qo(t, e, i) {
        ...
        let n = parseFloat(s);
        return a(n) && Math.floor(n) === n ? function(t, e, i, s) { "-" !== t && "+" !== t || (i = e + i); if (i === e || i < 0 || i >= s) return !1; return i }(s[0], e, n, i) : ["origin", "start", "end", "stack", "shape"].indexOf(s) >= 0 && s
    }
    ...
    function sa(t) {
        ...
        if (a(i)) return function(t, e) { const i = t.getDatasetMeta(e); return i && t.isDatasetVisible(e) ? i.dataset : null }(e, i);
    ...
    function na(t, e, i) {
        ...
        }(t, { line: n, target: s, above: c, below: d, area: i, scale: o, axis: a }), Ie(t))
    }
    ...
    function oa(t, e, i) {
        ...
        t.beginPath();
        for (const r of s) {
            const { start: s, end: l } = r, h = n[s], c = n[qo(s, l, n)];
    ...
    function ra(t, e, i) { const { top: s, bottom: n } = e.chart.chartArea, { property: o, start: a, end: r } = i || {}; "x" === o && (t.beginPath(), t.rect(a, s, r - a, n - s), t.clip()) }
    ...
    var ha = {
        ...
        afterDatasetsUpdate(t, e, i) {
            const s = (t.data.datasets || []).length,
                n = [];
            let o, a, r, l;
            for (a = 0; a < s; ++a) o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof Zn && (l = { visible: t.isDatasetVisible(a), index: a, fill: Qo(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }), o.$filler = l, n.push(l);
    ...
    const ca = (t, e) => { let { boxHeight: i = e, boxWidth: s = e } = t; return t.usePointStyle && (i = Math.min(i, e), s = t.pointStyleWidth || Math.min(s, e)), { boxWidth: s, boxHeight: i, itemHeight: Math.max(e, i) } };
    class da extends Bs {
            ...
            return this.legendItems.forEach(((t, o) => {
                const { itemWidth: p, itemHeight: m } = function(t, e, i, s, n) {
                    const o = function(t, e, i, s) {
                        ...
                        a = function(t, e, i) { let s = t; "string" != typeof e.text && (s = ua(e, i)); return s }(n, s, e.lineHeight);
        ...
        _draw() {
            const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this, { align: n, labels: o } = t, a = ue.color, r = Di(t.rtl, this.left, this.width), h = wi(o.font), { padding: c } = o, d = h.size, u = d / 2;
            let f;
            this.drawTitle(), s.textAlign = r.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = h.string;
            const { boxWidth: g, boxHeight: p, itemHeight: m } = ca(o, d), b = this.isHorizontal(), x = this._computeTitleHeight();
            ...
            this.legendItems.forEach(((y, v) => {
                ...
                if (function(t, e, i) {
                        ...
                        s.restore()
                    }(r.x(S), P, y), S = gt(w, S + g + u, b ? S + k : this.right, t.rtl), function(t, e, i) { Ve(s, i.text, t, e + m / 2, h, { strikethrough: i.hidden, textAlign: r.textAlign(i.textAlign) }) }(r.x(S), P, y), b) f.x += k + c;
    ...
    function ua(t, e) { return e * (t.text ? t.text.length + .5 : 0) }
    var fa = {
        id: "legend",
        _element: da,
        start(t, e, i) {
        ...
        stop(t) { ns.removeBox(t, t.legend), delete t.legend },
        beforeUpdate(t, e, i) {
            const s = t.legend;
                ...
                generateLabels(t) {
                    ...
                    return t._getSortedDatasetMetas().map((t => {
                        const l = t.controller.getStyle(i ? 0 : void 0),
                            h = Mi(l.borderWidth);
                        return { text: e[t.index].label, fillStyle: l.backgroundColor, fontColor: o, hidden: !t.visible, lineCap: l.borderCapStyle, lineDash: l.borderDash, lineDashOffset: l.borderDashOffset, lineJoin: l.borderJoinStyle, lineWidth: (h.width + h.height) / 4, strokeStyle: l.borderColor, pointStyle: s || l.pointStyle, rotation: l.rotation, textAlign: n || l.textAlign, borderRadius: a && (r || l.borderRadius), datasetIndex: t.index }
                    }), this)
                }
            },
    ...
    var ba = {
        ...
        stop(t) { ns.removeBox(t, ma.get(t)), ma.delete(t) },
        beforeUpdate(t, e, i) {
            const s = ma.get(t);
            ns.configure(t, s, i), s.options = i
        },
    ...
    function _a(t, e) { return e && (n(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t }

    function ya(t) { return ("string" == typeof t || t instanceof String) && t.indexOf("\n") > -1 ? t.split("\n") : t }

    function va(t, e) { const { element: i, datasetIndex: s, index: n } = e, o = t.getDatasetMeta(s).controller, { label: a, value: r } = o.getLabelAndValue(n); return { chart: t, label: a, parsed: o.getParsed(n), raw: t.data.datasets[s].data[n], formattedValue: r, dataset: o.getDataset(), dataIndex: n, datasetIndex: s, element: i } }
    ...
    function Ma(t, e) {
        ...
        return i.save(), i.font = h.string, u(t.title, y), i.font = l.string, u(t.beforeBody.concat(t.afterBody), y), _ = e.displayColors ? a + 2 + e.boxPadding : 0, u(s, (t => { u(t.before, y), u(t.lines, y), u(t.after, y) })), _ = 0, i.font = c.string, u(t.footer, y), i.restore(), b += p.width, { width: b, height: m }
    }
    ...
    function ka(t, e, i) { const s = i.yAlign || e.yAlign || function(t, e) { const { y: i, height: s } = e; return i < s / 2 ? "top" : i > t.height - s / 2 ? "bottom" : "center" }(t, i); return { xAlign: i.xAlign || e.xAlign || wa(t, e, i, s), yAlign: s } }

    function Sa(t, e, i, s) { const { caretSize: n, caretPadding: o, cornerRadius: a } = t, { xAlign: r, yAlign: l } = i, h = n + o, { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = vi(a); let g = function(t, e) { let { x: i, width: s } = t; return "right" === e ? i -= s : "center" === e && (i -= s / 2), i }(e, r); const p = function(t, e, i) { let { y: s, height: n } = t; return "top" === e ? s += i : s -= "bottom" === e ? n + i : n / 2, s }(e, l, h); return "center" === l ? "left" === r ? g += h : "right" === r && (g -= h) : "left" === r ? g -= Math.max(c, u) + n : "right" === r && (g += Math.max(d, f) + n), { x: J(g, 0, s.width - e.width), y: J(p, 0, s.height - e.height) } }

    function Pa(t, e, i) { const s = Mi(i.padding); return "center" === e ? t.x + t.width / 2 : "right" === e ? t.x + t.width - s.right : t.x + s.left }

    function Da(t) { return _a([], ya(t)) }

    function Ca(t, e) { const i = e && e.dataset && e.dataset.tooltip && e.dataset.tooltip.callbacks; return i ? t.override(i) : t }
    const Oa = {
        beforeTitle: e,
        title(t) {
            if (t.length > 0) {
    ...
    function Aa(t, e, i, s) { const n = t[e].call(i, s); return void 0 === n ? Oa[e].call(i, s) : n }
    class Ta extends Bs {
        ...
        getTitle(t, e) { const { callbacks: i } = e, s = Aa(i, "beforeTitle", this, t), n = Aa(i, "title", this, t), o = Aa(i, "afterTitle", this, t); let a = []; return a = _a(a, ya(s)), a = _a(a, ya(n)), a = _a(a, ya(o)), a }
        getBeforeBody(t, e) { return Da(Aa(e.callbacks, "beforeBody", this, t)) }
        getBody(t, e) {
        ...
        getAfterBody(t, e) { return Da(Aa(e.callbacks, "afterBody", this, t)) }
        getFooter(t, e) { const { callbacks: i } = e, s = Aa(i, "beforeFooter", this, t), n = Aa(i, "footer", this, t), o = Aa(i, "afterFooter", this, t); let a = []; return a = _a(a, ya(s)), a = _a(a, ya(n)), a = _a(a, ya(o)), a }
        _createItems(t) {
            const e = this._active,
                i = this.chart.data,
                s = [],
        ...
        drawBody(t, e, i) {
            const { body: s } = this, { bodySpacing: n, bodyAlign: o, displayColors: a, boxHeight: r, boxWidth: l, boxPadding: h } = i, c = wi(i.bodyFont);
            let d = c.lineHeight,
                f = 0;
        ...
        drawFooter(t, e, i) {
            const s = this.footer,
                n = s.length;
            let o, a;
            if (n) { const r = Di(i.rtl, this.x, this.width); for (t.x = Pa(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = wi(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing }
        }
        drawBackground(t, e, i, s) {
            const { xAlign: n, yAlign: o } = this, { x: a, y: r } = t, { width: l, height: h } = i, { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = vi(s.cornerRadius);
        ...
        _positionChanged(t, e) { const { caretX: i, caretY: s, options: n } = this, o = xa[n.position].call(this, t, e); return !1 !== o && (i !== o.x || s !== o.y) }
    }
    var La = {
        id: "tooltip",
        _element: Ta,
        positioners: xa,
        afterInit(t, e, i) { i && (t.tooltip = new Ta({ chart: t, options: i })) },
        ...
        defaults: { enabled: !0, external: null, position: "average", backgroundColor: "rgba(0,0,0,0.8)", titleColor: "#fff", titleFont: { weight: "bold" }, titleSpacing: 2, titleMarginBottom: 6, titleAlign: "left", bodyColor: "#fff", bodySpacing: 2, bodyFont: {}, bodyAlign: "left", footerColor: "#fff", footerSpacing: 2, footerMarginTop: 6, footerFont: { weight: "bold" }, footerAlign: "left", padding: 6, caretPadding: 2, caretSize: 5, cornerRadius: 6, boxHeight: (t, e) => e.bodyFont.size, boxWidth: (t, e) => e.bodyFont.size, multiKeyBackground: "#fff", displayColors: !0, boxPadding: 0, borderColor: "rgba(0,0,0,0)", borderWidth: 0, animation: { duration: 400, easing: "easeOutQuart" }, animations: { numbers: { type: "number", properties: ["x", "y", "width", "height", "caretX", "caretY"] }, opacity: { easing: "linear", duration: 200 } }, callbacks: Oa },
